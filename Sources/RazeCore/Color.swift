...
extension RazeCore {
    ...
    public class Color {
        ...
        /// Returns an objcet of `UIColor` with the second most eye-pleasing color known to all  humanity
        public static var secondaryRazeColor: UIColor {
            return self.fromHexString("FCFFFD")
        }
        
        /// Allows you convert a 6 digit hexadecimal string into a UIColor instance
        /// - Parameters:
        ...
        /// - Returns: A UIColor defined by `hexString` parameter
